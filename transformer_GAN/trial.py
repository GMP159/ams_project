...
class TransformerGenerator(nn.Module):
    def _init_(self, noise_dim, embed_size, num_layers, heads, device, forward_expansion, dropout, max_length):
...
class TransformerDiscriminator(nn.Module):
    def _init_(self, input_dim, embed_size, num_layers, heads, device, forward_expansion, dropout, max_length):
        super(TransformerDiscriminator, self)._init_()
        self.device = device
        self.embed_size = embed_size
        self.max_length = max_length
